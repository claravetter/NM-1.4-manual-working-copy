...
```{figure} Images/4.1_NM_dataentry_nifti_header.png
---
name: fig:4.1_NM_dataentry_nifti_header
...
```{figure} Images/4.1_NM_dataentry_select_data_origin.png
---
alt: neurominer data entry types
name: fig:4.1_NM_dataentry_select_data_origin
---
```

These [data input format](4.1_datainput_format) options will be described in more detail in the following sections.
...
```{figure} Images/4.1_NM_dataentry_spm_smallheader.png
---
name: fig:4.1_NM_dataentry_spm_smallheader
...
```{figure} Images/4.1_NM_dataentry_nifti_smallheader.png
---
name: fig:4.1_NM_dataentry_nifti_smallheader
...
```{figure} Images/4.1_NM_dataentry_surf_smallheader.png
---
name: fig:4.1_NM_dataentry_surf_smallheader
...
```{figure} Images/4.1_NM_dataentry_matrix_workspace.png
---
name: fig:4.1_NM_dataentry_matrix_workspace
...
```{figure} Images/4.1_NM_item_selector.png
---
align: left
name: fig:4.1_NM_feature_selector
...
```{figure} Images/4.1_NM_dataentry_matrix_matfile.png
---
align: left
name: fig:4.1_NM_dataentry_matrix_matfile
---
...
```{figure} Images/4.1_NM_dataentry_matrix_txtfile.png
---
name: fig:4.1_NM_dataentry_matrix_txtfile
...
```{figure} Images/4.1_NM_dataentry_matrix_spreadsheet.png
---
align: left
name: fig:4.1_NM_dataentry_matrix_spreadsheet
...
```{figure} Images/4.1_NM_dataentry_add_more.png
---
name: fig:4.1_NM_dataentry_add_more
...
```{figure} Images/4.1_NM_dataentry_modality_manager.png
---
name: fig:4.1_NM_dataentry_modality_manager
