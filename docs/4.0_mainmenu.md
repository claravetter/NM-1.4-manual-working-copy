...
```{figure} Images/4.0_NM_start_window.png
---
name: fig:4.0_NM_start_screen
alt: neurominer start display
---
```

It consists of 5 options that are numbered 1-5 as well as the option to go **Back/Quit (Q)**. To select an option, simply enter the number associated with it. The number you've entered will appear next to "Menu choice (1-5/Q) (Default: Q)?", if you made a mistake, you can simply delete it and type again. If you've entered the correct number, press "Enter".
...
```{figure} Images/4.0_NM_mainmenu_after_dataentry.png
---
alt: neurominer main menu after data entry
name: fig:4.0_NM_mainmenu_after_dataentry
---
```
